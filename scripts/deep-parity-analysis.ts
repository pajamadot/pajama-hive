...
function analyzeDataModel(): FieldAnalysis[] {
  ...
  return entityMappings.map(([entity, cozeTable, hiveTable]) => {
    ...
    const fieldAliases: Record<string, string[]> = {
      'spaceid': ['workspaceid'],
      'creatorid': ['createdby', 'publishedby', 'userid'],
      'iconuri': ['iconurl'],
      'deletedat': ['deletedat'],
      'createdat': ['createdat'],
      'updatedat': ['updatedat'],
      ...
      'serverurl': ['baseurl', 'apihost'],
      'developerid': ['createdby'],
      'appid': ['appid', 'id'],
      'ownerid': ['ownerid', 'createdby'],
      'version': ['version'],
      'suburl': ['path'],
      'operation': ['inputschema', 'outputschema', 'openapispec'],
      ...
      'versiondesc': ['versiondescription', 'changelog'],
      'manifest': ['openapispec', 'config'],
      'openapidoc': ['openapispec'],
      'testrunresult': ['testresult', 'testrunsuccess'],
      'variablesmetaid': ['id'], // We don't use a separate vars meta table
      'prompt': ['systemprompt', 'promptconfig', 'content'],
      'plugin': ['pluginconfig', 'pluginids'],
      'knowledge': ['knowledgeconfig', 'knowledgebaseids'],
      'workflow': ['workflowconfig', 'workflowid'],
      'suggestreply': ['suggestreply', 'suggestedReplies'],
      'jumpconfig': ['jumpconfig'],
      'backgroundimageinfolist': ['backgroundimages'],
      'shortcutcommand': ['shortcutcommands'],
      'layoutinfo': ['layoutinfo'],
      'onboardinginfo': ['onboardinginfo'],
      'modelinfo': ['modelinfo', 'modelconfigid'],
      'databaseconfig': ['databaseconfig'],
      'formattype': ['formattype', 'documenttype'],
      'sectionid': ['lastsectionid', 'sectionid'],
      'ext': ['metadata', 'extrainfo'],
      ...
      'replyid': ['replyid'],
      'brokenposition': ['isfinish'],
      'metainfo': ['metadata'],
      'uniquename': ['slug'],
      'email': ['id'], // Clerk handles email
      'password': ['id'], // Clerk handles password
      'locale': ['preferences'],
      'userid': ['userid'],
      'variablelist': ['defaultvalue', 'value'],
      'biztype': ['scope'],
      'bizid': ['scopeid'],
      'publishid': ['id'],
      'connectorids': ['config'],
      'publishinfo': ['snapshot'],
      'publishtime': ['publishedat'],
      'extra': ['metadata', 'config'],
      'commitid': ['commitid'],
      'modified': ['modified'],
      'testresult': ['testrunsuccess'],
    };
